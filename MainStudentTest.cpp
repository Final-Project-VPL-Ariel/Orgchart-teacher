...
//
// 1. This test file should include tests for all the functions in your program.
// 2. The tests should be written using the doctest framework.
// 3. The tests should be written in a separate file, called Test.cpp.
// 4. The tests should be compiled and run as part of the makefile.
// 5. The tests should be run as part of the submission process.
// 6. The tests should be run on the submission machine.
...
TEST_CASE ("Case 1 - Family tree")
{
    ...
    vector<std::string> rv_lvl_order;
